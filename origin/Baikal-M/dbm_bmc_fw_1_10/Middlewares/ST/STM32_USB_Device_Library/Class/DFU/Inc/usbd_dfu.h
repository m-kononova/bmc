...
#define USB_DFU_CONFIG_DESC_SIZ        (18 + (9 * USBD_DFU_MAX_ITF_NUM) + 66 + 31)
...
/**************************************************/
#define DFU_CMD_GETCOMMANDS            0x00  // wLength = ?
#define DFU_CMD_SETADDRESSPOINTER      0x21  // wLength = 5
#define DFU_CMD_ERASE                  0x41  // wLength = 5
#define DFU_CMD_MASS_ERASE             0x41  // wLength = 1
#define DFU_CMD_READ_UNPROTECT         0x92  // wLength = 1
